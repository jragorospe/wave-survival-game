...
// Begin Class UWaveAttributeComponent Function ApplyDamageMultiplier
struct Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics
{
	struct WaveAttributeComponent_eventApplyDamageMultiplier_Parms
	{
		AActor* InstigatorActor;
		float Multiplier;
		bool ReturnValue;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::NewProp_InstigatorActor = { "InstigatorActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WaveAttributeComponent_eventApplyDamageMultiplier_Parms, InstigatorActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::NewProp_Multiplier = { "Multiplier", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WaveAttributeComponent_eventApplyDamageMultiplier_Parms, Multiplier), METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((WaveAttributeComponent_eventApplyDamageMultiplier_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(WaveAttributeComponent_eventApplyDamageMultiplier_Parms), &Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::NewProp_InstigatorActor,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::NewProp_Multiplier,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWaveAttributeComponent, nullptr, "ApplyDamageMultiplier", nullptr, nullptr, Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::WaveAttributeComponent_eventApplyDamageMultiplier_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::WaveAttributeComponent_eventApplyDamageMultiplier_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWaveAttributeComponent::execApplyDamageMultiplier)
{
	P_GET_OBJECT(AActor,Z_Param_InstigatorActor);
	P_GET_PROPERTY(FFloatProperty,Z_Param_Multiplier);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->ApplyDamageMultiplier(Z_Param_InstigatorActor,Z_Param_Multiplier);
	P_NATIVE_END;
}
// End Class UWaveAttributeComponent Function ApplyDamageMultiplier
...
// Begin Class UWaveAttributeComponent Function GetDamage
struct Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics
{
	struct WaveAttributeComponent_eventGetDamage_Parms
	{
		float ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WaveAttributeComponent_eventGetDamage_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWaveAttributeComponent, nullptr, "GetDamage", nullptr, nullptr, Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::WaveAttributeComponent_eventGetDamage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::WaveAttributeComponent_eventGetDamage_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UWaveAttributeComponent_GetDamage()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWaveAttributeComponent_GetDamage_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWaveAttributeComponent::execGetDamage)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class UWaveAttributeComponent Function GetDamage
...
// Begin Class UWaveAttributeComponent Function GetRageMax
struct Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics
{
	struct WaveAttributeComponent_eventGetRageMax_Parms
	{
		float ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WaveAttributeComponent_eventGetRageMax_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWaveAttributeComponent, nullptr, "GetRageMax", nullptr, nullptr, Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::WaveAttributeComponent_eventGetRageMax_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::WaveAttributeComponent_eventGetRageMax_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWaveAttributeComponent::execGetRageMax)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(float*)Z_Param__Result=P_THIS->GetRageMax();
	P_NATIVE_END;
}
// End Class UWaveAttributeComponent Function GetRageMax
...
// Begin Class UWaveAttributeComponent Function IsFullRage
struct Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics
{
	struct WaveAttributeComponent_eventIsFullRage_Parms
	{
		bool ReturnValue;
	};
#if WITH_METADATA
...
void Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((WaveAttributeComponent_eventIsFullRage_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(WaveAttributeComponent_eventIsFullRage_Parms), &Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWaveAttributeComponent, nullptr, "IsFullRage", nullptr, nullptr, Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::WaveAttributeComponent_eventIsFullRage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::WaveAttributeComponent_eventIsFullRage_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWaveAttributeComponent::execIsFullRage)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->IsFullRage();
	P_NATIVE_END;
}
// End Class UWaveAttributeComponent Function IsFullRage
...
// Begin Class UWaveAttributeComponent Function MulticastDamageChanged
struct WaveAttributeComponent_eventMulticastDamageChanged_Parms
{
	AActor* InstigatorActor;
	float NewDamage;
	float Multiplier;
};
static FName NAME_UWaveAttributeComponent_MulticastDamageChanged = FName(TEXT("MulticastDamageChanged"));
void UWaveAttributeComponent::MulticastDamageChanged(AActor* InstigatorActor, float NewDamage, float Multiplier)
{
	WaveAttributeComponent_eventMulticastDamageChanged_Parms Parms;
	Parms.InstigatorActor=InstigatorActor;
	Parms.NewDamage=NewDamage;
	Parms.Multiplier=Multiplier;
	ProcessEvent(FindFunctionChecked(NAME_UWaveAttributeComponent_MulticastDamageChanged),&Parms);
}
struct Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "ActionSystem/WaveAttributeComponent.h" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::NewProp_InstigatorActor = { "InstigatorActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WaveAttributeComponent_eventMulticastDamageChanged_Parms, InstigatorActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::NewProp_NewDamage = { "NewDamage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WaveAttributeComponent_eventMulticastDamageChanged_Parms, NewDamage), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::NewProp_Multiplier = { "Multiplier", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WaveAttributeComponent_eventMulticastDamageChanged_Parms, Multiplier), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::NewProp_InstigatorActor,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::NewProp_NewDamage,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::NewProp_Multiplier,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWaveAttributeComponent, nullptr, "MulticastDamageChanged", nullptr, nullptr, Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::PropPointers), sizeof(WaveAttributeComponent_eventMulticastDamageChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00084CC0, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::Function_MetaDataParams) };
static_assert(sizeof(WaveAttributeComponent_eventMulticastDamageChanged_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWaveAttributeComponent::execMulticastDamageChanged)
{
	P_GET_OBJECT(AActor,Z_Param_InstigatorActor);
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->MulticastDamageChanged_Implementation(Z_Param_InstigatorActor,Z_Param_NewDamage,Z_Param_Multiplier);
	P_NATIVE_END;
}
// End Class UWaveAttributeComponent Function MulticastDamageChanged
...
// Begin Class UWaveAttributeComponent Function RevertToBaseDamage
struct Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics
{
	struct WaveAttributeComponent_eventRevertToBaseDamage_Parms
	{
		AActor* InstigatorActor;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::NewProp_InstigatorActor = { "InstigatorActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(WaveAttributeComponent_eventRevertToBaseDamage_Parms, InstigatorActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::NewProp_InstigatorActor,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UWaveAttributeComponent, nullptr, "RevertToBaseDamage", nullptr, nullptr, Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::PropPointers), sizeof(Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::WaveAttributeComponent_eventRevertToBaseDamage_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::Function_MetaDataParams), Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::WaveAttributeComponent_eventRevertToBaseDamage_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UWaveAttributeComponent::execRevertToBaseDamage)
{
	P_GET_OBJECT(AActor,Z_Param_InstigatorActor);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->RevertToBaseDamage(Z_Param_InstigatorActor);
	P_NATIVE_END;
}
// End Class UWaveAttributeComponent Function RevertToBaseDamage
...
void UWaveAttributeComponent::StaticRegisterNativesUWaveAttributeComponent()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "ApplyDamageMultiplier", &UWaveAttributeComponent::execApplyDamageMultiplier },
		...
		{ "GetDamage", &UWaveAttributeComponent::execGetDamage },
		...
		{ "GetRageMax", &UWaveAttributeComponent::execGetRageMax },
		{ "IsAlive", &UWaveAttributeComponent::execIsAlive },
		{ "IsFullHealth", &UWaveAttributeComponent::execIsFullHealth },
		{ "IsFullRage", &UWaveAttributeComponent::execIsFullRage },
		{ "Kill", &UWaveAttributeComponent::execKill },
		{ "MulticastDamageChanged", &UWaveAttributeComponent::execMulticastDamageChanged },
		...
		{ "RevertToBaseDamage", &UWaveAttributeComponent::execRevertToBaseDamage },
	};
...
struct Z_Construct_UClass_UWaveAttributeComponent_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OnDamageChanged_MetaData[] = {
		{ "Category", "Attributes" },
		{ "ModuleRelativePath", "ActionSystem/WaveAttributeComponent.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnDamageChanged;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UWaveAttributeComponent_ApplyDamageMultiplier, "ApplyDamageMultiplier" }, // 1416103942
		...
		{ &Z_Construct_UFunction_UWaveAttributeComponent_GetDamage, "GetDamage" }, // 1422187450
		...
		{ &Z_Construct_UFunction_UWaveAttributeComponent_GetRageMax, "GetRageMax" }, // 1438131226
		...
		{ &Z_Construct_UFunction_UWaveAttributeComponent_IsFullRage, "IsFullRage" }, // 1828752213
		{ &Z_Construct_UFunction_UWaveAttributeComponent_Kill, "Kill" }, // 1483940094
		{ &Z_Construct_UFunction_UWaveAttributeComponent_MulticastDamageChanged, "MulticastDamageChanged" }, // 3137440707
		{ &Z_Construct_UFunction_UWaveAttributeComponent_MulticastHealthChanged, "MulticastHealthChanged" }, // 289482484
		{ &Z_Construct_UFunction_UWaveAttributeComponent_MulticastRageChanged, "MulticastRageChanged" }, // 3460082350
		{ &Z_Construct_UFunction_UWaveAttributeComponent_RevertToBaseDamage, "RevertToBaseDamage" }, // 77142277
	};
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWaveAttributeComponent_Statics::NewProp_Damage = { "Damage", nullptr, (EPropertyFlags)0x0020080000010035, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveAttributeComponent, Damage), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Damage_MetaData), NewProp_Damage_MetaData) };
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UWaveAttributeComponent_Statics::NewProp_OnDamageChanged = { "OnDamageChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UWaveAttributeComponent, OnDamageChanged), Z_Construct_UDelegateFunction_WaveSurvival_OnAttributeChanged__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnDamageChanged_MetaData), NewProp_OnDamageChanged_MetaData) }; // 1723944188
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UWaveAttributeComponent_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWaveAttributeComponent_Statics::NewProp_Damage,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWaveAttributeComponent_Statics::NewProp_OnDamageChanged,
};
...
struct Z_CompiledInDeferFile_FID_Users_jrago_Documents_GitHub_WaveSurvival_WaveSurvival_Source_WaveSurvival_ActionSystem_WaveAttributeComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UWaveAttributeComponent, UWaveAttributeComponent::StaticClass, TEXT("UWaveAttributeComponent"), &Z_Registration_Info_UClass_UWaveAttributeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaveAttributeComponent), 3451828323U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_jrago_Documents_GitHub_WaveSurvival_WaveSurvival_Source_WaveSurvival_ActionSystem_WaveAttributeComponent_h_2005696709(TEXT("/Script/WaveSurvival"),
